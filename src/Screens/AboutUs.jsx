    ...
    <>
      ...
      <div className='flex flex-col items-center gap-10 p-6  miFuenteBold sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl w-full text-black bg-[#EBF4E2]'>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }}
            ...
            viewport={{ once: true }} className='bg-[#EBF4E2] p-4 max-w-[1100px] mt-25 rounded-lg text-center'>
        <h1 className='miFuenteBold sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[#001A57] '>SOBRE NOSOTROS</h1>
        ...
        <h1 className='miFuenteBold mt-10 text-base sm:text-md md:text-lg lg:text-xl xl:text-[25px] '>¿Sos PAS y queres formar parte de nuestro equipo?</h1>
        <Link
          to="/teamForm"
