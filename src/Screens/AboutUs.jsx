...
const AboutUs = () => {
  return (
    <>
      ...
      <div className='flex flex-col items-center p-4 gap-10 miFuenteBold sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl  text-black  '>
        <Carousel />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }}
            ...
            viewport={{ once: true }} className=' max-w-[1100px] mt-20 rounded-lg text-center'>
        <h1 className='miFuenteBold sm:text-3xl md:text-4xl lg:text-6xl xl:text-6xl text-[#D6A77A] '>SOBRE NOSOTROS</h1>
        ...
        <Link
          to="/teamForm"
          className="px-5 py-2 bg-[#D6A77A] text-base sm:text-md md:text-lg lg:text-xl xl:text-[25px] miFuenteBold rounded-md hover:bg-[#A17D5C] transition duration-300"
        >
          Registrate acá
        </Link>
      </div>
